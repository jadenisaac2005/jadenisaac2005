...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&pause=1000&color=6366F1&center=true&vCenter=true&width=600&lines=Hi%2C+I'm+Jaden+Isaac+%F0%9F%91%8B;AI+%26+ML+Engineer+in+Training;I+Build+Models+From+Scratch;" alt="Typing SVG" />
</div>

<br/>

<div align="center">
  <em>BTech AI & ML student building neural networks and ML systems from first principles — no framework doing the thinking for me.</em>
</div>

---

## 🔧 What I Focus On
- Building neural networks and ML pipelines from scratch (NumPy, C++) to actually understand what frameworks abstract away.
- Shipping end-to-end ML systems — model + API + frontend — not just notebooks.
- Writing up what broke and what worked, with real numbers, not just "it works."
...
XGBoost risk classifier (SMOTE + StandardScaler) on a 100,000-row synthetic slope-stability dataset — sole developer on a 3-person team, Smart India Hackathon 2025. FastAPI backend, React dashboard, SMS alerting via Twilio on the highest risk tier.
